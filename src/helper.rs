...
//
// Adapted from https://github.com/supertone-inc/supertonic/tree/main/rust
// (Apache-2.0). Parts of this module are unused by the Wyoming server, but
// are kept to match the upstream surface for easier future cherry-picks.
// ============================================================================
